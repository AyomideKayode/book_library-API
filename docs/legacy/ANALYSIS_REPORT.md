...
- **Load Testing (k6 or Artillery):** Simulating concurrent users borrowing the _same_ book to verify that the race condition handling (optimistic locking/transactions) actually prevents double-booking under load.
